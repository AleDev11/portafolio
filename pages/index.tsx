...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center justify-center relative h-full">
            <div className="flex flex-col items-center justify-center bg-zinc-900 rounded-2xl shadow-md shadow-current w-80 h-80 hover:shadow-lg hover:shadow-current">
